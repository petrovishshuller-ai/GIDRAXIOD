-- ============================================================
-- GIDRAXIOD - БЕЗ ИНВИЗА + NIGHT VISION (УБИРАЕТ ТЕМНОТУ)
-- ============================================================
...
function startAimLoop()
    ...
    aimLoop = RunService.RenderStepped:Connect(function()
        if aimEnabled then
            ...
            if aimTarget and aimTarget.Parent and isVisible(aimTarget) then
...
print("✅ Night Vision полностью убирает темноту (яркость MAX, тени выключены).")
